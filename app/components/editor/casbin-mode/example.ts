...
`,
  ...
  return {
     ...
     * See https://casbin.apache.org/docs/function#functions-in-matchers for more details.
     */
    functions: {},
    /**
     * The value comes from config.functions, Casbin will not use this configuration if the value is undefined.
     * See https://casbin.apache.org/docs/rbac#use-pattern-matching-in-rbac for more details.
     * example:
